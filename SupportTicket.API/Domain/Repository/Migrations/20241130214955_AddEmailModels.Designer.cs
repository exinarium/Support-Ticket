...
namespace SupportTicket.API.Domain.Repository.Migrations
{
    ...
    [Migration("20241130214955_AddEmailModels")]
    partial class AddEmailModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SupportTicket.API.Domain.Repository.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2024, 11, 30, 21, 49, 55, 84, DateTimeKind.Utc).AddTicks(5970),
                            IsActive = true,
                            Name = "DefaultAccount"
                        });
                });
            ...
            modelBuilder.Entity("SupportTicket.API.Domain.Repository.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2024, 11, 30, 21, 49, 55, 112, DateTimeKind.Utc).AddTicks(394),
                            ...
                            LastName = "Creativ360",
                            Password = "VIrV0/xvjfAJusHbeq43YQ==/DtI89V51mY2eHAYKkicSrlZIZmxMh8lO7Kq5E7u1hqs="
                        });
                });
