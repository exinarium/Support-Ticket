...
namespace SupportTicket.API.Domain.Repository.Migrations
{
    ...
    [Migration("20241224210422_RemoveRequiredFieldsFromTicket")]
    partial class RemoveRequiredFieldsFromTicket
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SupportTicket.API.Domain.Repository.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2024, 12, 24, 21, 4, 22, 45, DateTimeKind.Utc).AddTicks(9160),
                            IsActive = true,
                            Name = "DefaultAccount"
                        });
                });
            ...
            modelBuilder.Entity("SupportTicket.API.Domain.Repository.Models.Email", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<List<string>>("AttachmentFileNames")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("attachmentFileNames");
                    ...
                    b.Property<bool>("IsSMTPEmail")
                        .HasColumnType("boolean")
                        .HasColumnName("isSMTPEmail");

                    b.Property<Dictionary<string, string>>("KeyValuePairs")
                        .IsRequired()
                        .HasColumnType("hstore")
                        .HasColumnName("keyValuePairs");

                    b.Property<List<string>>("ReplyTo")
                        .IsRequired()
                        .HasColumnType("text[]")
            ...
            modelBuilder.Entity("SupportTicket.API.Domain.Repository.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDateTime = new DateTime(2024, 12, 24, 21, 4, 22, 69, DateTimeKind.Utc).AddTicks(2880),
                            ...
                            LastName = "Creativ360",
                            Password = "VqJyGxkAbt9dxbKt/N+/rA==__g89VUXhcjHwnH/cDPZ8i8IKiCSyUMi1izSFQsinstgA="
                        });
                });
